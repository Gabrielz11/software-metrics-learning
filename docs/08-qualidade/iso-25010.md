...
??? check "Mostrar Gabarito / Resposta"
    1. **Quantidade de características:** 9 características (Adequação Funcional, Eficiência de Desempenho, Compatibilidade, Usabilidade, Confiabilidade, Segurança, Manutenibilidade, Portabilidade e Segurança Operacional).
    2. **Security vs. Safety:** *Security* refere-se à proteção de dados contra acessos não autorizados e ataques maliciosos; *Safety* refere-se à prevenção de riscos de falha que possam causar danos à integridade física humana, patrimonial ou ao meio ambiente.
    3. **Manutenibilidade:** Avalia o grau de facilidade com que o software pode ser modificado, corrigido, melhorado ou adaptado pelos desenvolvedores (modularidade, reusabilidade, testabilidade, modificabilidade e analisabilidade).
    4. **Subcaracterísticas da Adequação Funcional:** Completo funcional, Correção funcional e Adequação funcional (*Functional Completeness, Functional Correctness, Functional Appropriateness*).
    5. **Norma substituta:** A ISO/IEC 25010 (dentro da família SQuaRE) substituiu a ISO/IEC 9126.
